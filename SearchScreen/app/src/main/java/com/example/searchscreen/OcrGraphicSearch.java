 ...
 * overlay view.
 */
public class OcrGraphicSearch extends GraphicOverlay.Graphic {
    ...
    OcrGraphicSearch(GraphicOverlay overlay, Text text) {
        super(overlay);
    ...
    public boolean contains(float x, float y) {
        ...
        RectF rect = new RectF(searchText.getBoundingBox());
